...
import { FaLock, FaArrowRight, FaCheck, FaEye, FaEyeSlash } from 'react-icons/fa';
                    ...
                    <div className="relative group">
                        ...
                        {!isSuccess && password && (
                            <button
                                ...
                                className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#dc2626]/60 hover:text-[#dc2626] transition-colors z-10"
                            >
